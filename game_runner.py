...
def run_game(asp: AdversarialSearchProblem, agents, game_ui=None):
    """
    Inputs:
    ...
    return asp.get_reward(asp.get_start_state())
...
def main():
    ...
    if game == 'ttt':
        ...
        if args.dimension is not None:
            if args.dimension < 3:
                parser.error("--dimension msut be at least 4 for Connect Four")
